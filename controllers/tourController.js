...
exports.resizeTourImages = catchAsync(async (req, res, next) => {
  ...
  console.log({ imageCover: req.body.imageCover, images: req.body.images });

  // Image processing: resize, format and save
...
exports.deleteTour = factory.delteOne(Tour);

// GET TOUR STASTICS USING AGGREGATION
